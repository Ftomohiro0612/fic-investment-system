...
- WordPress投稿ID: `12484`
- スラッグ: `oji-holdings-3861-analysis`
- 最終HTML: `work/company_analysis/3861_oji/codex_reviewed_article.v3.with_wp_images.html`
- 次工程handoff: `work/company_analysis/3861_oji/handoff_image_wp_to_x_or_video.md`
- 2026-05-18 追記3: 画像方針をAI画像2枚体制に修正。上流環境・業績波及マップをAI生成版へ差し替え、旧非AIドライバーマップ media ID `12486` とローカル旧PNGを削除。

## 完了したこと

- 非AI構造図を作成: `work/company_analysis/3861_oji/images/oji-holdings-3861-driver-map.png`
- AI生成の投資仮説マップを作成: `work/company_analysis/3861_oji/images/oji-holdings-3861-investment-thesis-map-ai.png`
- 画像挿入済みHTMLを作成: `work/company_analysis/3861_oji/codex_reviewed_article.with_images.html`
- v3骨格のClaude本文に2画像を挿入したプレビューHTMLを作成: `work/company_analysis/3861_oji/claude_article.v3.with_images_preview.html`
