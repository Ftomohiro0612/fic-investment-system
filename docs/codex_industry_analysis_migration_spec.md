...
| 企業 | コード | YTD/QTD騰落率 | 時点 | PER | コンセンサス予想（売上/利益） | 出典 | 確度 |
|---|---:|---|---|---|---|---|---|

- 公式IR・主要メディア由来は確度: 強
- データ集計サイト（Yahoo Finance、Investing.com、Simply Wall St、ad-hoc-news等）は確度: 補助。記事中心根拠にはしないが、織り込み度合いを示す本文補助情報として渡してよい
- 数値の単位と為替前提を必ず明記する

### 11.5.2 アナリスト・専門家コメント候補
...
### 11.5.6 過去類似テーマの織り込みパターン

| 類似テーマ | 起点イベント | 関連銘柄の反応 | 反応の持続期間 | その後の業績確認 | 今回への示唆 |
|---|---|---|---|---|---|

- TSMC/JASM熊本、ラピダス、AI/HPC、ADAS/車載カメラなど類似テーマを最低1件、運用が安定したら最低2件
- 「期待先行か実需か」を判断する補助材料として活用する

### 11.5.7 業種別 業績ドライバー分解式
...
- [ ] 株価織り込み度合いデータが、確度（強/補助）付きで整理されている
